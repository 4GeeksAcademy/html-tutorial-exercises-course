...
1. Add a width attribute to the `<table>` of 100% and a border of 1 (don't use CSS! use basic HTML attributes in the tags).

2. Add to the `<tr>` tag inside of the `<thead>` tag a height of 40px and red background color (Use inline styling for it).
