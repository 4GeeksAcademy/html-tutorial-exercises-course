...
describe('Format the exact same styles with pure html, use h1 headings, paragraph, strong, blockquote, ol and il', function () {
   ...
   it('Order of html tags', function () {
       if(document.querySelector("h1")){
        expect(document.querySelectorAll("h1,p, ol,li,a,h2,ul")[0].tagName).toStrictEqual(document.querySelector("h1").tagName)
       }
        if(document.querySelector("ol")){
        expect(document.querySelectorAll("h1,p, ol,li,a,h2, ul")[3].tagName).toStrictEqual(document.querySelector("ol").tagName)
       }
        if(document.querySelector("ul")){
        expect(document.querySelectorAll("h1,p, ol,li,a,h2,ul")[8].tagName).toStrictEqual(document.querySelector("ul").tagName)
       }
       if(document.querySelector("a")){
        expect(document.querySelectorAll("h1,p, ol,li,a,h2,ul")[13].tagName).toStrictEqual(document.querySelector("a").tagName)
       }
       ...
       if(document.querySelector("li")){
           for(let i=0;i<document.querySelectorAll("h1,p, ol,li,a,h2,ul").length;i++){
               let arr=[4,5,6,9,10,11]
               if(i===arr[i])
        expect(document.querySelectorAll("h1,p, ol,li,a,h2,ul")[i].tagName).toStrictEqual(document.querySelector("li").tagName)
       }
       }
